...
int main()
{
    ...
    // 工程化约定：构建后 CMake 会把 src/day04/shaders/ 复制到 build/shaders/day04/
    // 所以运行时从 build 目录启动，可用下面的相对路径读取
    Shader ourShader("shaders/day04/vertex.glsl", "shaders/day04/fragment.glsl");
    Texture texture1("assets/day04/trinket_box.jpg");
    Texture texture2("assets/day04/awesomeface.png");
    // glEnable(GL_BLEND);
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(VAO);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0); // 6 个索引 = 两个三角形
